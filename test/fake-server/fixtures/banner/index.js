/**
 * This function will return the 'Request' object for 'Banner' media type.
 * Adunit that generates this request:
 * ```
 * [{
...
/**
 * This function will return the 'Response' object, correcponding to the Request object above, for the 'Banner' media type.
  ...
  return {
    'httpResponse': {
      'body': {
        'version': '3.0.0',
        'tags': [{
          // 'uuid': '2c8c83a1deaf1a', // we don't require 'uuid' property since it gets its value from 'uuid' of the incoming request.
          'tag_id': 13144370,
          ...
          'ads': [{
            ...
            'media_subtype_id': 1,
            'cpm': 0.600000,
            'cpm_publisher_currency': 0.600000,
