...
describe('Unit: Prebid Module', function () {
  ...
  describe('getAdserverTargeting', function() {
    ...
    it('should get correct ' + TARGETING_KEYS.PRICE_BUCKET + ' when using bid.cpm is between 5 to 8', function () {
      ...
      let bidTargeting = targeting.getAllTargeting();
      /* gu-mod-start */
      expect(bidTargeting['div-gpt-ad-1460505748561-0'][TARGETING_KEYS.PRICE_BUCKET]).to.equal('6.78');
      /* gu-mod-end */
    });
    ...
    it('should get correct ' + TARGETING_KEYS.PRICE_BUCKET + ' when using bid.cpm is between 8 to 20', function () {
      ...
      let bidTargeting = targeting.getAllTargeting();
      /* gu-mod-start */
      expect(bidTargeting['div-gpt-ad-1460505748561-0'][TARGETING_KEYS.PRICE_BUCKET]).to.equal('19.52');
      /* gu-mod-end */
    });
    ...
    it('should get correct ' + TARGETING_KEYS.PRICE_BUCKET + ' when using bid.cpm is between 20 to 25', function () {
      ...
      let bidTargeting = targeting.getAllTargeting();
      /* gu-mod-start */
      expect(bidTargeting['div-gpt-ad-1460505748561-0'][TARGETING_KEYS.PRICE_BUCKET]).to.equal('21.52');
      /* gu-mod-end */
    });
  });
