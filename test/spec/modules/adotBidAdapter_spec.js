...
describe('Adot Adapter', function () {
  ...
  describe('buildRequests', function () {
    it('should build request (banner)', function () {
      ...
      const bidderRequest = { position: 2, refererInfo: { page: 'http://localhost.com', domain: 'localhost.com' }, gdprConsent: { consentString: 'consentString', gdprApplies: true }, schain: { ver: '1.0' } };
