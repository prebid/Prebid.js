...
describe('Adot Adapter', function () {
  ...
  describe('buildRequests', function () {
    it('should build request (banner)', function () {
      ...
      const bidderRequest = { position: 2, refererInfo: { page: 'http://localhost.com', domain: 'localhost.com' }, gdprConsent: { consentString: 'consentString', gdprApplies: true }, userId: { pubProvidedId: 'userId' }, ortb2: { source: { ext: { schain: { ver: '1.0' } } } } };
