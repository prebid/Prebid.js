...
import { OPENRTB, spec } from 'modules/precisoBidAdapter.js';
import { newBidder } from 'src/adapters/bidderFactory.js';
import { config } from 'src/config.js';

describe('PrecisoAdapter', () => {
  ...
  describe('isBidRequestValid', function () {
    ...
    it('should return false when required params are not passed', function () {
      let bid3 = Object.assign({}, bid);
      delete bid3.params;
      delete bid3.mediaTypes;
      bid3.params = {
  ...
  describe('buildRequests', function () {
    ...
    it('sends bid request to ENDPOINT via POST', function () {
      ...
      expect(request.url).to.equal('https://prebid-eu.mndtrk.com/bidder/prebid/bids');
    ...
    context('FLEDGE', function() {
      ...
      it('sends bid request to FLEDGE ENDPOINT via POST', function () {
        ...
        expect(request.url).to.equal('https://prebid-eu.mndtrk.com/bidder/prebidfledge/bids');
        expect(request.method).to.equal('POST');
      });
  ...
  describe('interpretResponse', function () {
      ...
      let expectedResponse = [
        {
          ...
          'currency': 'USD',
          'ttl': 300,
          'meta': { advertiserDomains: ['preciso.com'] },
          'netRevenue': true
        }
      ];
      let bidderRequest;
    ...
    describe('native', () => {
      ...
      it('should contain native assets in valid format', () => {
        ...
        expect(bids[0].meta.advertiserDomains).to.deep.equal(['preciso.com']);
