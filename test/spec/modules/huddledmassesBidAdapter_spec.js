...
describe('HuddledmassesAdapter', function () {
  let bid = {
  ...
  describe('isBidRequestValid', function () {
    it('Should return true when placement_id can be cast to a number, and when at least one of the sizes passed is allowed', function () {
    ...
    it('Should return false when the sizes are not allowed', function () {
      bid.sizes = [[1, 1]];
      expect(spec.isBidRequestValid(bid)).to.be.false;
    });
  });
  ...
  describe('buildRequests', function () {
    ...
    it('Returns valid URL', function () {
      expect(serverRequest.url).to.equal('https://huddledmassessupply.com/?c=o&m=multi');
    });
  ...
  describe('getUserSyncs', function () {
    ...
    it('Returns valid URL and type', function () {
      ...
      expect(userSync[0].url).to.be.equal('https://huddledmassessupply.com/?c=o&m=cookie');
    });
  });
});
