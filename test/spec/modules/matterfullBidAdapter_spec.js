...
import { spec } from 'modules/matterfullBidAdapter.ts';
...
describe('matterfullBidAdapter', () => {
  ...
  describe('interpretResponse', function () {
    ...
    it('should interpret valid response', function () {
      ...
      expect(bid.meta).to.deep.equal({ advertiserDomains: ['matterfull'] });
    });
