...
describe('CleanmedianetAdapter', function () {
  ...
  describe('interpretResponse', function () {
    ...
    it('validates in/existing of gdpr consent', function () {
      ...
      expect(result[0].url).to.equal('https://bidder.cleanmediaads.com/pix/1275/scm?cb=1545900621675&gc=consent%20string');
      ...
      expect(result.length).to.equal(1);
      expect(result[0].type).to.equal('image');
      expect(result[0].url).to.equal('https://bidder.cleanmediaads.com/pix/1275/scm?cb=1545900621675&gc=missing');
      ...
      expect(result.length).to.equal(1);
      expect(result[0].type).to.equal('image');
      expect(result[0].url).to.equal('https://bidder.cleanmediaads.com/pix/1275/scm?gc=missing');
    });
  });
});
