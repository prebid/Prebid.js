...
describe('CleanmedianetAdapter', function () {
  ...
  describe('Is String start with search ', function () {
    it('check if a string started with', function () {
      expect(helper.startsWith('cleanmediaads.com', 'cleanmediaads')).to.equal(true);
    });
  });
  ...
  describe('buildRequests', function () {
    ...
    it('targets correct endpoint', function () {
      ...
      bidRequestWithEndpoint.params.rtbEndpoint = 'https://bidder2.cleanmediaads.com/a12';
      response = spec.buildRequests([bidRequestWithEndpoint])[0];
      expect(response.url).to.match(new RegExp(`^https://bidder2\\.cleanmediaads\\.com/a12/r/${supplyPartnerId}/bidr\\?rformat=open_rtb&reqformat=rtb_json&bidder=prebid$`, 'g'));
    });
          ...
          'bid': [
            {
              ...
              'nurl': 'https://bidder.cleanmediaads.com/pix/monitoring/win_notice/imp_5b05b9fde4b09084267a556f/im.gif?r=imp_5b05b9fde4b09084267a556f&i=1&a=579ef31bfa788b9d2000d562&b=0&p=${AUCTION_PRICE}',
              'adm': '<img width="300px" height="250px" src="https://dummyimage.com/300x250/030d00/52b31e.gif&text=Clean+Media+Demo" onclick="window.open(\'https://www.cleanmediaads.com\')"> <img width="0px" height="0px" src="https://bidder.cleanmediaads.com/pix/monitoring/imp/imp_5b05b9fde4b09084267a556f/im.gif?r=imp_5b05b9fde4b09084267a556f&i=1&a=579ef31bfa788b9d2000d562&b=0"/>',
              'adomain': ['aaa.com'],
          ...
          'bid': [
            {
              ...
              'nurl': 'https://bidder.cleanmediaads.com/pix/monitoring/win_notice/imp_5b05b9fde4b09084267a556f/im.gif?r=imp_5b05b9fde4b09084267a556f&i=1&a=579ef31bfa788b9d2000d562&b=0&p=${AUCTION_PRICE}',
              'adm': '<img width="300px" height="250px" src="https://dummyimage.com/300x250/030d00/52b31e.gif&text=Clean+Media+Demo" onclick="window.open(\'https://www.cleanmediads.com\')"> <img width="0px" height="0px" src="https://bidder.cleanmediaads.com/pix/monitoring/imp/imp_5b05b9fde4b09084267a556f/im.gif?r=imp_5b05b9fde4b09084267a556f&i=1&a=579ef31bfa788b9d2000d562&b=0"/>',
              'adomain': ['bbb.com'],
    ...
    it('supports configuring outstream renderers', function () {
      const videoResponse = {
            ...
            'bid': [
              {
                ...
                'price': 5.0,
                'adid': '1274',
                'nurl': 'https://bidder.cleanmediaads.com/pix/1275/win_notice/imp_5c24924de4b0d106447af333/im.gif?r=imp_5c24924de4b0d106447af333&i=afbb5852-7cea-4a81-aa9a-a41aab505c23&a=1274&b=gb_1&p=${AUCTION_PRICE}',
                'adomain': [],
        ...
        'ext': {
          'utrk': [{
            'type': 'image',
            'url': 'https://bidder.cleanmediaads.com/pix/1275/scm?cb=1545900621675'
          }]
        }
      };
