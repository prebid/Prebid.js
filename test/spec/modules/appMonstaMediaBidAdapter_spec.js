...
import { spec } from '../../../modules/appMonstaMediaBidAdapter.js';
import { BANNER, VIDEO, NATIVE } from '../../../src/mediaTypes.js';
import { getUniqueIdentifierStr } from '../../../src/utils.js';

const bidder = 'appMonstaMedia';

describe('appMonstaMediaBidAdapter', function () {
  const userIdAsEids = [{
    source: 'test.org',
    uids: [{
      id: '01**********',
  ...
  describe('buildRequests', function () {
    ...
    it('Returns valid URL', function () {
      expect(serverRequest.url).to.equal('https://ssp-us.appmonsta.ai/pbjs');
    });
