import {spec} from '../../../modules/resultsmediaBidAdapter.js';
import * as utils from '../../../src/utils.js';
import * as sinon from 'sinon';

var r1adapter = spec;

describe('resultsmedia adapter tests', function () {
  beforeEach(function() {
  ...
  describe('misc buildRequests', function() {
    it('should send GDPR Consent data to resultsmedia tag', function () {
      var bidRequestList = [
        {
          'bidder': 'resultsmedia',
          'params': {
