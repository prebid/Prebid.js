...
import { spec } from '../../../modules/precisonatBidAdapter.js';
...
describe('PrecisoAdapter', function () {
  ...
  describe('buildRequests', function () {
    ...
    // it('should not contain banner in imp', function() {
    //   let data = serverRequest.data;
    //   expect(data.imp.banner).to.be.undefined
    // });

    it('should extract the native params', function() {
      let data = serverRequest.data;
      const asset = JSON.parse(data.imp[0].native.request).assets[0]
  ...
  describe('interpretResponse', function () {
    it('should get correct bid response', function () {
      ...
      logInfo('bid response given::' + response);
