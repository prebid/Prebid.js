  ...
  describe('buildRequests', function () {
    const bidRequests = [
      ...
      { // bannerWithHyperId
        ...
        transactionTd: 'f76f6dfd-d64f-4645-a29f-682bac7f431a',
        userId: {
          novatiq: {'id': 'novatiqId', syncResponse: 1}
        }
      }
    ];
    const bidderRequest = {
    ...
    const data = {
      ...
      bannerWithHyperId: `posall=SSPLOC&id=58278&sdktype=0&hb=true&t=json3&sizes=320x100&currency=JPY&pbver=${prebid.version}&sdkname=prebidjs&adapterver=1.2.0&imark=1&tp=https%3A%2F%2Fexample.com&hyper_id=novatiqId`,
    };
