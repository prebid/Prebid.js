...
import {spec} from 'modules/paradocsBidAdapter.js';

const ENDPOINT_URL = 'https://balam.paradocs.ru/hb';
const REFERRER_URL = 'http://referrer.url/?_=';

describe('Paradocs adapter', function () {
      ...
      it('should return complete bid response', function () {
        let serverResponse = {
          body: {
            ...
            width: 240,
            height: 240,
            content_url: 'https://balam.paradocs.ru/hb',
        ...
        expect(bids[0].adUrl).to.have.string('https://balam.paradocs.ru/hb');
