...
describe('SmartXSP Adapter', function () {
  ...
  describe('isBidRequestValid', function () {
    ...
    it('should return false when the notifyId does not match smartxsp one', function () {
      bid.params.notifyId = 'f1514724-0922-4b45-a297-27531aeb829a';
      window.smartxsp = { notifyId: '5c444a48-7713-4333-a895-44b1ae793417' };
  ...
  describe('getNotifyId', function () {
    ...
    it('generates a notifyId (not in params, not in smartxsp)', function () {
      const params = Object.freeze({});
      window.smartxsp = {};
      const notifyId = spec.getNotifyId(params);
      expect(spec.isValidNotifyId(notifyId)).to.be.true;
      expect(window.smartxsp.notifyId).to.equal(notifyId);
    });

    it('uses smartxsp notifyId (not in params, present in smartxsp)', function () {
      const params = Object.freeze({});
      window.smartxsp = { notifyId: '5c444a48-7713-4333-a895-44b1ae793417' };
      const notifyId = spec.getNotifyId(params);
      expect(notifyId).to.equal('5c444a48-7713-4333-a895-44b1ae793417');
      expect(window.smartxsp.notifyId).to.equal('5c444a48-7713-4333-a895-44b1ae793417');
    });

    it('assigns notifyId from params to smartxsp (present in params, not in smartxsp)', function () {
      ...
      expect(window.smartxsp.notifyId).to.equal('f1514724-0922-4b45-a297-27531aeb829a');
    });

    it('returns notifyId from params (same in params & in smartxsp)', function () {
      const params = Object.freeze({ notifyId: 'f1514724-0922-4b45-a297-27531aeb829a' });
      window.smartxsp = { notifyId: 'f1514724-0922-4b45-a297-27531aeb829a' };
      const notifyId = spec.getNotifyId(params);
      expect(notifyId).to.equal('f1514724-0922-4b45-a297-27531aeb829a');
      expect(window.smartxsp.notifyId).to.equal('f1514724-0922-4b45-a297-27531aeb829a');
    });

    it('returns notifyId from params (present in params & in smartxsp, with mismatch)', function () {
      const params = Object.freeze({ notifyId: 'f1514724-0922-4b45-a297-27531aeb829a' });
      window.smartxsp = { notifyId: '5c444a48-7713-4333-a895-44b1ae793417' };
      const notifyId = spec.getNotifyId(params);
      expect(notifyId).to.equal('f1514724-0922-4b45-a297-27531aeb829a');
      expect(window.smartxsp.notifyId).to.equal('5c444a48-7713-4333-a895-44b1ae793417'); // did not change
    });
  });
  ...
  describe('interpretResponse', function () {
    ...
    it('should add advertiserDomains', function () {
      ...
      responseWithAdvertiserDomains.advertiserDomains = ['a_smartxsp_adomain'];
