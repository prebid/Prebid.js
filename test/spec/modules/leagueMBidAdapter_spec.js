...
import {spec} from 'modules/leagueMBidAdapter.js';
...
describe('leagueMBidAdapter', () => {
  ...
  describe('interpretResponse', function () {
    ...
    it('should interpret valid response', function () {
      ...
      expect(bid.meta).to.deep.equal({advertiserDomains: ['leagueM']});
    });
