...
import { spec } from 'modules/anzuDSPBidAdapter.ts';
...
describe('anzuDSPBidAdapter', () => {
  ...
  describe('interpretResponse', function () {
    ...
    it('should interpret valid response', function () {
      ...
      expect(bid.meta).to.deep.equal({ advertiserDomains: ['anzuDSP'] });
    });
