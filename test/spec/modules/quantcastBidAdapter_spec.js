...
describe("Quantcast adapter", () => {
  ...
  describe("sizes", () => {
    ...
    it("should call server once even when multiple sizes are passed", () => {
      ...
      expect(ajaxStub.firstCall.args[2]).to.include(
      ...
      expect(ajaxStub.firstCall.args[3]).to.eql({
        method: "POST",
  ...
  describe("handleQuantcastCB add bids to the manager", () => {
    ...
    it("should exist and be a function", () => {
      expect($$PREBID_GLOBAL$$.handleQuantcastCB).to.exist.and.to.be.a(
        "function"
      );
    });
    ...
    it("should add a bid object for each bid", () => {
      ...
      expect(addBidReponseStub.firstCall.args[0]).to.eql(
        "div-gpt-ad-1438287399331-0"
      );
    });
