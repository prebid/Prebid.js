...
import { spec } from '../../../modules/bidmyadzBidAdapter.js';
import { BANNER, VIDEO, NATIVE } from '../../../src/mediaTypes.js';
import { getUniqueIdentifierStr } from '../../../src/utils.js';

const bidder = 'bidmyadz'

describe('BidmyadzBidAdapter', function () {
  const bids = [
    {
  ...
  describe('buildRequests', function () {
    ...
    it('Returns valid URL', function () {
      expect(serverRequest.url).to.equal('https://endpoint.bidmyadz.com/pbjs');
    });
  ...
  describe('getUserSyncs', function() {
    it('Should return array of objects with proper sync config , include GDPR', function() {
      ...
      expect(syncData[0].url).to.equal('https://cookie-sync.bidmyadz.com/image?pbjs=1&gdpr=1&gdpr_consent=ALL&coppa=0')
    });
    it('Should return array of objects with proper sync config , include CCPA', function() {
      ...
      expect(syncData[0].type).to.equal('image')
      expect(syncData[0].url).to.be.a('string')
      expect(syncData[0].url).to.equal('https://cookie-sync.bidmyadz.com/image?pbjs=1&ccpa_consent=1---&coppa=0')
    });
  });
});
