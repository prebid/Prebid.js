...
describe('sirdataRtdProvider', function() {
  ...
  describe('Get Segments And Categories', function() {
    it('gets data from async request and adds segment data', function() {
      ...
      let data = {"segments":[111111,222222],"segtaxid":null,"cattaxid":null,"contextual_categories":{"333333":100},"shared_taxonomy":{"27440":{"segments":[444444,555555],"segtaxid":552,"cattaxid":553,"contextual_categories":{"666666":100}}},"global_taxonomy":{"9998":{"segments":[123,234],"segtaxid":4,"cattaxid":7,"contextual_categories":{"345":100,"456":100}}}};
      ...
      //expect(reqBidsConfigObj.adUnits[0].bids[0].params.keywords).to.have.deep.property('custom', ['111111', '222222', '333333']);
