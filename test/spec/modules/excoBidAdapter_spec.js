  ...
  describe('getUserSyncs', function () {
    it('should have valid user sync with iframeEnabled', function () {
      ...
      expect(result).to.deep.equal([{
        type: 'iframe',
        url: 'https://cs.exco-pb.com/api/sync/iframe/?cid=testcid123&gdpr=0&gdpr_consent=&us_privacy=&coppa=0'
      }]);
    });
    ...
    it('should have valid user sync with pixelEnabled', function () {
      ...
      expect(result).to.deep.equal([{
        'url': 'https://cs.exco-pb.com/api/sync/image/?cid=testcid123&gdpr=0&gdpr_consent=&us_privacy=&coppa=0',
        'type': 'image'
      }]);
    });
    ...
    it('should have valid user sync with coppa on response', function () {
      ...
      expect(result).to.deep.equal([{
        type: 'iframe',
        url: 'https://cs.exco-pb.com/api/sync/iframe/?cid=testcid123&gdpr=0&gdpr_consent=&us_privacy=&coppa=1'
      }]);
    });
  });
