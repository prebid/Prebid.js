...
describe('User ID', function () {
  ...
  describe('Handle variations of config values', function () {
    ...
    it('handles config with no usersync object', function () {
      setSubmoduleRegistry([pubCommonIdSubmodule, unifiedIdSubmodule, id5IdSubmodule, identityLinkSubmodule, merkleIdSubmodule, netIdSubmodule, sharedIdSubmodule, intentIqIdSubmodule, zeotapIdPlusSubmodule, pubProvidedIdSubmodule, criteoIdSubmodule, tapadIdSubmodule, uid2IdSubmodule]);
      init(config);
      config.setConfig({});
    ...
    it('config with 1 configurations should create 1 submodules', function () {
      setSubmoduleRegistry([pubCommonIdSubmodule, unifiedIdSubmodule, id5IdSubmodule, identityLinkSubmodule, netIdSubmodule, sharedIdSubmodule, intentIqIdSubmodule, zeotapIdPlusSubmodule, pubProvidedIdSubmodule, criteoIdSubmodule, tapadIdSubmodule, uid2IdSubmodule]);
      init(config);
    ...
    it('config with 15 configurations should result in 15 submodules add', function () {
      ...
      expect(utils.logInfo.args[0][0]).to.exist.and.to.contain('User ID - usersync config updated for 15 submodules');
    });

    it('config syncDelay updates module correctly', function () {
      setSubmoduleRegistry([pubCommonIdSubmodule, unifiedIdSubmodule, id5IdSubmodule, identityLinkSubmodule, netIdSubmodule, sharedIdSubmodule, intentIqIdSubmodule, zeotapIdPlusSubmodule, haloIdSubmodule, pubProvidedIdSubmodule, criteoIdSubmodule, tapadIdSubmodule, uid2IdSubmodule]);
      init(config);
      config.setConfig({
        userSync: {
          syncDelay: 99,
  ...
  describe('Request bids hook appends userId to bid objs in adapters', function () {
    ...
    it('test hook from UID 2.0 cookie', function (done) {
    ...
    it('test hook from UID 2.0 html5', function (done) {
      // simulate existing browser local storage values
    ...
    it('test hook when pubCommonId, unifiedId, id5Id, identityLink, britepoolId, intentIqId, zeotapIdPlus, sharedId, netId, haloId, uid2Id and Criteo have data to pass', function (done) {
      ...
      setSubmoduleRegistry([pubCommonIdSubmodule, unifiedIdSubmodule, id5IdSubmodule, identityLinkSubmodule, britepoolIdSubmodule, netIdSubmodule, sharedIdSubmodule, intentIqIdSubmodule, zeotapIdPlusSubmodule, haloIdSubmodule, criteoIdSubmodule, tapadIdSubmodule, uid2IdSubmodule]);
      init(config);
      config.setConfig(getConfigMock(['pubCommonId', 'pubcid', 'cookie'],
      ...
      requestBidsHook(function () {
        ...
        coreStorage.setCookie('uid2', '', EXPIRED_COOKIE_DATE);
        done();
      }, {adUnits});
    });
