...
import { buildRequests, interpretResponse, getUserSyncs } from '../../../../libraries/precisoUtils/precisoUtils.js';
...
describe('bidderOperations', function () {
  ...
  describe('getUserSyncs', function () {
    const syncUrl = `https://${TESTDOMAIN}/rtb/user/usersync.aspx?id=undefined&gdpr=0&gdpr_consent=&us_privacy=&t=4`;
    const syncOptions = {
      iframeEnabled: true
    };
