describe('centro adapter tests', function() {
  ...
  describe('creation of bid url', function() {
    ...
    it('should fix parameter name', function() {
      ...
      expect(parsedBidUrlQueryString).to.have
        .property('url')
        .and.to.equal('http://test_url.ru');
      expect(parsedBidUrlQueryString).to.have
        .property('sz')
        .and.to.equal('300x250');
      expect(parsedBidUrlQueryString).to.have
        .property('callback')
        .and.to.equal(generatedCallback);
