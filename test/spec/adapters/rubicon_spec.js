...
describe('the rubicon adapter', () => {
  let sandbox, adUnit, bidderRequest;
  ...
  describe('callBids public interface', () => {
    ...
    it('should receive a well-formed bidRequest from the adaptermanager', () => {
      ...
      expect(bidderRequest).to.have
        .property('bids')
        .that.is.an('array')
        .with.lengthOf(1);

      expect(bidderRequest).to.have.deep
        .property('bids[0]')
  ...
  describe('callBids implementation', () => {
    ...
    describe('for requests', () => {
      ...
      describe('for video requests', () => {
        beforeEach(() => {
          ...
          sandbox.stub(Date, 'now', () => bidderRequest.auctionStart + 100);
        });
        ...
        it('should make a well-formed video request', () => {
          ...
          expect(post.ae_pass_through_parameters).to.have
            .property('p_aso.video.ext.skip')
            .that.equals('1');
          expect(post.ae_pass_through_parameters).to.have
            .property('p_aso.video.ext.skipdelay')
            .that.equals('15');

          expect(post).to.have.property('slots').with.length.of(1);
    ...
    describe('response handler', () => {
      let bids, server, addBidResponseAction;
