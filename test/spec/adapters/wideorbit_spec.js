describe('wideorbit adapter tests', function() {
  ...
  describe('creation of bid url', function() {
    ...
    it('should fix parameters name', function() {
      ...
      expect(parsedBidUrlQueryString).to.have
        .property('jscb')
        .and.to.equal('window.$$PREBID_GLOBAL$$.handleWideOrbitCallback');
      ...
      expect(parsedBidUrlQueryString).to.have
        .property('url')
        .and.to.equal('http://www.foo.com?param1=param1&param2=param2');
      ...
      expect(parsedBidUrlQueryString).to.have
        .property('gid1')
        .and.to.equal('div-gpt-ad-12345-2');
      expect(parsedBidUrlQueryString).to.have
        .property('rpos1')
        .and.to.equal('0');
      expect(parsedBidUrlQueryString).to.have
