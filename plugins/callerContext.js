...
const NAMES = {
  'src/ajax.js': {
    ...
    message: 'request credentials (ajax `withCredentials` / fetch `credentials: \'include\') may be unexpectedly denied. Consider using one of the "qualified" or "noCreds" variants of ajax / fetch.'
  }
}
