...
### 2. Make sure all browserstack tests are passing
   ...
   On PR merge to master, GitHub Actions will run unit tests on browserstack. Checking the last GitHub Actions build [here](https://github.com/prebid/Prebid.js/actions) for master branch will show you detailed results.**
