...
exports.cacheWithLocation = cacheWithLocation;
exports.detectReferer = detectReferer;
exports.ensureProtocol = ensureProtocol;
exports.getRefererInfo = void 0;
...
function detectReferer(win) {
  ...
  function refererInfo() {
    ...
    const maxNestedIframes = _config.config.getConfig('maxNestedIframes');
    let currentWindow;
    let bestLocation;
    ...
    const canonicalUrl = _config.config.getConfig('pageUrl') || bestCanonicalUrl || null;
    let page = _config.config.getConfig('pageUrl') || location || ensureProtocol(canonicalUrl, win);
 ...
 */
const getRefererInfo = exports.getRefererInfo = cacheWithLocation(detectReferer(window));