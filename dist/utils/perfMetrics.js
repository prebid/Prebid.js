...
exports.CONFIG_TOGGLE = void 0;
exports.hookTimer = hookTimer;
exports.metricsFactory = metricsFactory;
exports.timedBidResponseHook = exports.timedAuctionHook = exports.newMetrics = void 0;
exports.useMetrics = useMetrics;
var _config = require("../config.js");
const CONFIG_TOGGLE = exports.CONFIG_TOGGLE = 'performanceMetrics';
...
let enabled = true;
_config.config.getConfig(CONFIG_TOGGLE, cfg => {
...
const newMetrics = exports.newMetrics = (() => {
...
const timedAuctionHook = exports.timedAuctionHook = hookTimer('requestBids.', req => req.metrics);
const timedBidResponseHook = exports.timedBidResponseHook = hookTimer('addBidResponse.', (_, bid) => bid.metrics);