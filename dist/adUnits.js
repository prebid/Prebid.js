...
function getRequestsCounter(adunit) {
  return (0, _utils.deepAccess)(adUnits, "".concat(adunit, ".requestsCounter")) || 0;
}
...
function getBidderRequestsCounter(adunit, bidder) {
  return (0, _utils.deepAccess)(adUnits, "".concat(adunit, ".bidders.").concat(bidder, ".requestsCounter")) || 0;
}
...
function getBidderWinsCounter(adunit, bidder) {
  return (0, _utils.deepAccess)(adUnits, "".concat(adunit, ".bidders.").concat(bidder, ".winsCounter")) || 0;
}
 ...
 */
let adunitCounter = exports.adunitCounter = {
