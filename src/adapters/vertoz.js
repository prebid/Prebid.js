...
var VertozAdapter = function VertozAdapter() {
  ...
  function _callBids(params) {
    ...
    for (var i = 0; i < bids.length; i++) {
      ...
      let adspaceid = utils.getValue(bid,'placementCode');
      ...
      if(utils.isEmptyStr(placementId)||utils.isEmptyStr(adspaceid)){
        utils.logError('missing params:',BIDDER_NAME,'Enter valid vzPlacementId or check placementCode');
        return;
      }
