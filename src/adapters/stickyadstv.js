...
var StickyAdsTVAdapter = function StickyAdsTVAdapter() {
  ...
  function getBid(bid, callback) {
    ...
    bid.vast = (topMostWindow.stickyadstv_cache[
      bid.placementCode
    ] = vastLoader.getVast());
  ...
  var formatInBannerHTML = function(bid, size) {
    ...
    var script = "<script type='text/javascript'>" +
      ...
      'var vast =  topWindow.stickyadstv_cache["' +
      placementCode +
      '"];' +
      'var config = {' +
      '  preloadedVast:vast,' +
  ...
  var formatIntextHTML = function(bid) {
    ...
    if (
      !config.hasOwnProperty('domId') &&
      !config.hasOwnProperty('auto') &&
      !config.hasOwnProperty('p') &&
      !config.hasOwnProperty('article')
    ) {
