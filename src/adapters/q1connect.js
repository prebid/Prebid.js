...
module.exports = function(bidManager, global, loader){
	...
	function getBidRequestJson(bids, slotMap, bidParams){
		...
		findAndFillParam(o.site, "name", function(){return global.top.document.title;});
		...
		findAndFillParam(o.device, "h", function(){return global.screen.height;});
		findAndFillParam(o.device, "w", function(){return global.screen.width;});
