...
const AerServAdapter = function AerServAdapter() {
  ...
  function _addBidResponse(bidRequest, response) {
  ...
  function _buildQueryParameters(bidRequest, requestParams) {
    ...
    if (bidRequest.params.video) {
      ...
      .forEach(param => requestParams[param] = bidRequest.params.video[param]);
    }
  ...
  function _callBids(params) {
    ...
    bids.forEach(bidRequest => {
      if (utils.hasValidBidRequest(bidRequest.params, REQUIRED_PARAMS, BIDDER_CODE)) {
        ...
        let requestParams = {url: currentUrl};
        let parameterStr = _buildQueryParameters(bidRequest, requestParams);
        ...
        ajax(url, response => {
          ...
          _addBidResponse(bidRequest, response);
