...
exports.createTrackPixelIframeHtml = function (url) {
  ...
  return '<iframe frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0"'
    + ' width="0" hspace="0" vspace="0" height="0" style="height:0p;width:0p;display:none;"'
    + ' scrolling="no" src="' + encodeURI(url) + '"></iframe>';
};
