...
// eslint-disable-next-line prebid/validate-imports
import { RENDERER as SAFEFRAME_RENDERER } from '../creative-renderers/safe-frame.js'; // autogenerated during precompilation
...
export const getCreativeRendererSource = hook('sync', function (bidResponse) {
  if (bidResponse.safeFrameRendererUrl) {
    return SAFEFRAME_RENDERER;
  }
  return RENDERER;
})
