...
export function addBidRequestHook(next, bidRequest) {
  ...
  if (Array.isArray(overrides.bidRequests)) {
    const override = find(overrides.bidRequests, overrideBidRequest => (typeof overrideBidRequest.bidderCode === 'undefined' || overrideBidRequest.bidderCode === bidRequest.bidderCode || typeof overrideBidRequest.adUnitCode));
    if (override) {
