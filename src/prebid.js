...
/* private variables */
const { ADD_AD_UNITS, BID_WON, REQUEST_BIDS, BEFORE_REQUEST_BIDS, SET_TARGETING, AD_RENDER_FAILED } = CONSTANTS.EVENTS;
...
$$PREBID_GLOBAL$$.requestBids = hook('async', function ({ bidsBackHandler, timeout, adUnits, adUnitCodes, labels, auctionId } = {}) {
  ...
  /**
   * The event "BEFORE_REQUEST_BIDS" is fired after conditional adunit processing but before adunits are copied to bidrequests. Note the adunits array is passed to the event handler.
