...
/**
 * @typedef {ServerRequest & CustomServerRequestFields} AdvectServerRequest
 */

/**
 * Advect bidder-specific params which the publisher used in their bid request.
 *
 * @typedef {Object} AdvectBidRequestParams
...
const BIDDER_URL = 'https://bs.advect.ru/prebid';
...
export const spec = {
   ...
   * @returns {AdvectServerRequest[]} Objects describing the requests to the server.
   */
...
/**
 * @param {AdvectBidRequestParams} bidRequestParams
 */
 ...
 * @param {AdvectServerRequest} advectServerRequest
