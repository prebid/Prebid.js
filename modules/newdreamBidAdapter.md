...
```
Module Name:  Newdream Bid Adapter
...
Connects to Newdream exchange for bids.

Newdream bid adapter supports Banner, Video (instream and outstream) and Native.
   ...
   // Video outstream adUnit
   {
     ...
     mediaTypes: {
       video: {
         ...
         // To note - Newdream supports additional values for our system that are not part of the ORTB spec.  If you want
         // to use these values, they will have to be declared in the bids[].params.video object instead using the Newdream syntax.
