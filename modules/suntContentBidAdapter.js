...
const GVL_ID = 1097;
const BIDDER_CODE = 'suntContent';
const DEFAULT_CUR = 'EUR';
const ENDPOINT_URL = 'https://b.suntcontent.se/cds/rtb/bid?format=openrtb2.5&ssp=pb';
...
export const spec = {
  ...
  buildRequests: (validBidRequests = [], bidderRequest) => {
    ...
    return {
      method: 'POST',
      url: config.getConfig('suntContent.endpoint') || ENDPOINT_URL,
