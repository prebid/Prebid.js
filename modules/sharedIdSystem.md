...
pbjs.setConfig({
    userSync: {
        userIds: [{
            name: 'sharedId',
            params: {
                      syncTime: 60 // in seconds, default is 24 hours. -1 to disable periodic sync
             },
            storage: {
                name: 'sharedid',
                type: 'cookie',
...
| params.syncTime | Optional | Object | Configuration to define the frequency(in seconds) of id synchronization. Less than 0 means periodic sync is disabled. By default id is synchronized every 24 hours | 60 |
