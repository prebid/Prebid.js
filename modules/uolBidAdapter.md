...
```
Module Name:  Uol Bid Adapter
Module Type:  Bidder Adapter
Maintainer: l-dev-techops@uolinc.com
```

# Description

Connects to Uol exchange for bids.

Uol bid adapter supports Banner, Video (instream and outstream) and Native.
