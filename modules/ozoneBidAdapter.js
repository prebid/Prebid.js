...
export const spec = {
  ...
  buildRequests(validBidRequests, bidderRequest) {
    ...
    let arrRet = tosendtags.map(imp => {
      ...
      deepSetValue(ozoneRequestSingle, 'source.tid', bidderRequest.ortb2.source.tid);// RTB 2.5 : tid is Transaction ID that must be common across all participants in this bid request (e.g., potentially multiple exchanges).
