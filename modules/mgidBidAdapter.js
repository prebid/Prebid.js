...
import { getMgidSUAEnricher } from '../libraries/mgidUtils/mgidSUAEnricher.js';
...
export const enreachSUA = getMgidSUAEnricher();
...
const converter = ortbConverter({
  ...
  imp(buildImp, bidRequest, context) {
    ...
    if (storageId && isViewabilityEnabled()) {
...
function populateRequest(request, context) {
  ...
  const sua = enreachSUA(existingSua);
