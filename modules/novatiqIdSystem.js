 ...
 */
   ...
   getSharedId(configParams) {
     let sharedId = null;
     if (typeof configParams.useSharedId != 'undefined' && configParams.useSharedId === true) {
       ...
       sharedId = window.localStorage.getItem(cookieOrStorageID);
       if (sharedId == null) {
         // next check session storage
         sharedId = window.sessionStorage.getItem(cookieOrStorageID);
