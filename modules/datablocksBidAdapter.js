  ...
  buildRequests: function(validRequests, bidderRequest) {
    ...
    validRequests.forEach(bidRequest => {
      ...
      if (deepAccess(bidRequest, `mediaTypes.banner`)) {
        ...
        // ADD TO THE LIST OF IMP REQUESTS
        imp.native = bidderUtils.createNativeRequest(bidRequest.nativeParams, NATIVE_PARAMS);
        imps.push(imp);
      }
    });
    ...
    resBids.forEach(bid => {
      ...
      switch (mediaType) {
        ...
        case 'native':
          ...
          bids.push(Object.assign({}, resultItem, {mediaType: NATIVE, native: bidderUtils.parseNative(nativeResult.native, NATIVE_ID_MAP)}));
          break;
