...
export const sharethroughAdapterSpec = {
  ...
  buildRequests: (bidRequests, bidderRequest) => {
    ...
    const secure =
      nonHttp || sharethroughInternal.getProtocol().indexOf("https") > -1;
    ...
    const req = {
      ...
      bcat:
        deepAccess(bidderRequest.ortb2, "bcat") ||
        bidRequests[0].params.bcat ||
        [],
      badv:
        deepAccess(bidderRequest.ortb2, "badv") ||
        bidRequests[0].params.badv ||
        [],
      test: 0,
    };
    ...
    req.user.ext.eids = deepAccess(bidRequests[0], "userIdAsEids") || [];
    ...
    const imps = bidRequests
      .map((bidReq) => {
        ...
        const gpid = deepAccess(
          bidReq,
          "ortb2Imp.ext.gpid",
          deepAccess(bidReq, "ortb2Imp.ext.data.pbadslot")
        );
        ...
        if (videoRequest) {
          ...
          impression.video = {
            ...
            placement:
              videoRequest.context === "instream"
                ? 1
                : +deepAccess(videoRequest, "placement", 4),
          };
  ...
  getUserSyncs: (syncOptions, serverResponses) => {
    const shouldCookieSync =
      ...
      deepAccess(serverResponses, "0.body.cookieSyncUrls") !== undefined;
