    ...
    interpretResponse: function (serverResponse, request) {
        ...
        if (serverResponse.body) {
            ...
            var sRequestID = oResponse.requestId || '',
                nCPM = oResponse.cpm || 0 ,
                nWidth = oResponse.width || 0 ,
                nHeight = oResponse.height || 0 ,
                nTTL = oResponse.ttl || 0 ,
                sCreativeID = oResponse.creativeId || 0 ,
                sCurrency = oResponse.currency || 'USD' ,
                bNetRevenue = oResponse.netRevenue || true ,
                sAd = oResponse.ad || '' ;
