...
const ENDPOINT_URL = 'mndtrk.com/bidder/prebid/bids';
const FLEDGE_ENDPOINT_URL = 'mndtrk.com/bidder/prebidfledge/bids';
...
function mapSchain(schain) {
  ...
  if (!validateSchain(schain)) {
    logError('Preciso: required schain params missing');
    return null;
  }
  return schain;
}
