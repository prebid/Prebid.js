...
export const getMovingupLocalStorage = getLocalStorageFunctionGenerator<{ movingupId: string }>(
  STORAGE,
  BIDDER_CODE,
  MOVINGUP_KEY,
  'movingupId'
...
const converter = ortbConverter({
  ...
  imp(buildImp, bidRequest: BidRequest<typeof BIDDER_CODE>, context) {
    ...
    deepSetValue(imp, 'ext.movingup', bidRequest.params);
    return imp;
  },
