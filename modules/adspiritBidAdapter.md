        ...
        bids: [
            {
                ...
                params: {
                    ...
                    host: 'example.com' // Your host details from Adspirit
                }
            }
        ]
    },
...
3. Body Text (id:4): A brief description of the ad. The Body Text should have a maximum length of 200 characters.
...
This asset varies based on user requirements. You need to contact your business partner for the correct setup.
