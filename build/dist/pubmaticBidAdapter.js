...
function PubmaticAdapter() {
  ...
  function _createRequestContent() {
    ...
    content += '<body>';
    content += '<scr' + 'ipt>';
    content += '' + 'window.pm_pub_id  = "%%PM_PUB_ID%%";' + 'window.pm_optimize_adslots     = [%%PM_OPTIMIZE_ADSLOTS%%];' + 'window.kaddctr = "%%PM_ADDCTR%%";' + 'window.kadgender = "%%PM_GENDER%%";' + 'window.kadage = "%%PM_AGE%%";' + 'window.pm_async_callback_fn = "window.parent.pbjs.handlePubmaticCallback";';
